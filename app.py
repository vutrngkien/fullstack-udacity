...
def create_venue_submission():
    ...
    venue.city = new_venue['city']
    venue.state = new_venue['state']
    venue.phone = new_venue['phone']
    venue.facebook_link = new_venue['facebook_link']
    venue.image_link = new_venue['image_link']
    venue.website = new_venue['website_link']
    venue.genres = new_venue['genres']
    venue.seeking_talent = False
    venue.seeking_description = new_venue['seeking_description']
    if new_venue.get('seeking_talent') and new_venue['seeking_talent'] == 'y':
...
def create_artist_submission():
    ...
    artist.city = new_artist['city']
    artist.state = new_artist['state']
    artist.phone = new_artist['phone']
    artist.facebook_link = new_artist['facebook_link']
    artist.image_link = new_artist['image_link']
    artist.website = new_artist['website_link']
    if new_artist.get('seeking_venue') and new_artist['seeking_venue'] == 'y':
        artist.seeking_venue = True
    artist.seeking_description = new_artist['seeking_description']
    try:
